...
class BoltHeadDetector:
    ...
    #     plt.savefig(os.path.join(self.config['output_dir'], "P2_bolt_heads_entry_points.png"), dpi=300)
    #     plt.close()

    # def _plot_entry_points(self, region_info, filtered_mask, brain_mask, spacing, origin):
    #     """
    #     Plot bolt heads with entry points and generate a comprehensive PDF report
