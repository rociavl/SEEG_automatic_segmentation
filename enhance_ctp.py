...
def enhance_ctp(inputVolume, inputROI = None, methods = 'all', outputDir=None):
   ...
   # Check if the shapes match
    ...
    if methods == 'all':
        ...
        # enhanced_volumes['morphological_filter_closing_3'] = morph_operations(enhanced_volumes['morphological_filter_opening_2'], operation='close')
        # enhanced_volumes['sharpen_3'] = denoise_image(enhanced_volumes['morphological_filter_closing_3'])
        # enhanced_volumes['clahe_2'] = apply_clahe(enhanced_volumes['sharpen_3'])
        # enhanced_volumes['sharpen_2'] = sharpen_high_pass(enhanced_volumes['clahe_2'])
        # enhanced_volumes['closing_4'] = morph_operations(enhanced_volumes['sharpen_2'], operation='close')
        # enhanced_volumes['morphological_filter_opening_3'] = morph_operations(enhanced_volumes['closing_4'])
        # enhanced_volumes['sharpen_4'] = sharpen_high_pass(enhanced_volumes['morphological_filter_opening_3'])
        # enhanced_volumes['closing_5'] = morph_operations(enhanced_volumes['sharpen_3'], operation='close')
        # enhanced_volumes['closing_6'] = morph_operations(enhanced_volumes['closing_5'], operation='close')
        # enhanced_volumes['closing_7'] = morph_operations(enhanced_volumes['closing_6'], operation='close')
        # enhanced_volumes['sharpen_5'] = sharpen_high_pass(enhanced_volumes['closing_7'])
        # enhanced_volumes['canny_edges'] = canny_edges(enhanced_volumes['sharpen_5'])
