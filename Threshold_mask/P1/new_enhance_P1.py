...
def process_original_ctp(enhanced_volumes, volume_array, threshold_tracker):
    ...
    threshold = 2286
    enhanced_volumes['DESCARGAR_OG_volume_array_2286'] = np.uint8(enhanced_volumes['OG_volume_array'] > threshold)
...
def process_roi_gamma_mask(enhanced_volumes, final_roi, volume_array, threshold_tracker):
    ...
    threshold = 198
    enhanced_volumes['DESCARGAR_PRUEBA_roi_plus_gamma_mask_198'] = np.uint8(enhanced_volumes['PRUEBA_roi_plus_gamma_mask'] > threshold)
    ...
    threshold = 200
    enhanced_volumes['DESCARGAR_PRUEBA_THRESHOLD_CLAHE_200'] = np.uint8(enhanced_volumes['PRUEBA_roi_plus_gamma_mask_clahe'] > threshold)
    ...
    threshold = 192
    enhanced_volumes['DESCARGAR_PRUEBA_WAVELET_NL_192'] = np.uint8(enhanced_volumes['PRUEBA_WAVELET_NL'] > threshold)
...
def process_roi_only(enhanced_volumes, roi_volume, final_roi, threshold_tracker):
    ...
    threshold= 2266
    enhanced_volumes['DESCARGAR_WAVELET_ROI_2266'] = np.uint8(enhanced_volumes['wavelet_only_roi'] > threshold)
    ...
    threshold = 204
    enhanced_volumes['DESCARGAR_GAMMA_ONLY_ROI_204'] = np.uint8(enhanced_volumes['gamma_only_roi'] > threshold)
    threshold_tracker['gamma_only_roi'] = threshold
    
    # Threshold ROI volume
    threshold = 2056
    enhanced_volumes['DESCARGAR_Threshold_roi_volume_2056'] = np.uint8(enhanced_volumes['roi_volume'] > threshold)
...
def process_roi_plus_gamma_after(enhanced_volumes, final_roi, threshold_tracker):
    ...
    threshold = 0.71
    enhanced_volumes['DESCARGAR_2_gaussian_volume_roi_0.71'] = np.uint8(enhanced_volumes['2_gaussian_volume_roi'] > threshold)
    ...
    threshold = 139
    enhanced_volumes['DESCARGAR_2_LOG_139'] = np.uint8(enhanced_volumes['2_LOG'] > threshold)
    ...
    # Threshold sharpened volume
    threshold = 0.690
    enhanced_volumes['DESCARGAR_2_sharpening_2_trial_0.690'] = np.uint8(enhanced_volumes['2_sharpening_2_trial'] > threshold)
...
def process_wavelet_roi(enhanced_volumes, roi_volume, threshold_tracker):
    ...
    threshold = 1916
    enhanced_volumes['DESCARGAR_NUEVO_NLMEANS_1916'] = np.uint8(enhanced_volumes['NUEVO_NLMEANS'] > threshold)
...
def process_original_idea(enhanced_volumes, threshold_tracker):
    ...
    threshold = 0.593
    enhanced_volumes['DESCARGAR_ORGINAL_IDEA_gaussian_0.593'] = np.uint8(enhanced_volumes['ORGINAL_IDEA_gaussian'] > threshold)
    ...
    # Threshold gamma corrected volume
    threshold = 130
    enhanced_volumes['DESCARGAR_ORGINAL_IDEA_gamma_correction_130'] = np.uint8(enhanced_volumes['ORGINAL_IDEA_gamma_correction'] > threshold)
    ...
    # Threshold sharpened volume
    threshold = 123
    enhanced_volumes['DESCARGAR_ORGINAL_IDEA_sharpened_123'] = np.uint8(enhanced_volumes['ORGINAL_IDEA_sharpened'] > threshold)
    ...
    # Threshold wavelet result
    threshold = 134
    enhanced_volumes['DESCARGAR_ORIGINAL_IDEA_wavelet_134'] = np.uint8(enhanced_volumes['ORIGINAL_IDEA_wavelet'] > threshold)
    ...
    threshold = 0.473
    enhanced_volumes['DESCARGAR_ORGINAL_IDEA_gaussian_2_0.473'] = np.uint8(enhanced_volumes['ORGINAL_IDEA_gaussian_2'] > threshold)
    ...
    # Threshold top-hat result
    threshold = 0.468
    enhanced_volumes['DESCARGAR_OG_tophat_1_0.468'] = np.uint8(enhanced_volumes['OG_tophat_1'] > threshold)
...
def process_first_try(enhanced_volumes, roi_volume, threshold_tracker):
    ...
    threshold = 1024
    enhanced_volumes['DESCARGAR_FT_RESTA_TOPHAT_GAUSSIAN_1024'] = np.uint(enhanced_volumes['FT_RESTA_TOPHAT_GAUSSIAN'] > threshold)
    ...
    threshold = 123
    enhanced_volumes['DESCARGAR_FT_gamma_correction_123'] = np.uint8(enhanced_volumes['FT_gamma_correction'] > threshold)
...
# Output directory
outputDir = r"C:\Users\rocia\Downloads\TFG\Cohort\Enhance_ctp_tests\P1\TH45_histograms"
